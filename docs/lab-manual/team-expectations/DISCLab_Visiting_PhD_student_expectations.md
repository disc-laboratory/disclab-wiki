# Visiting PhD Student Expectations and Working Principles

This document outlines the main expectations, working norms, and professional responsibilities associated with a visiting PhD appointment in the **Digital Intelligence for Structures and Construction research group at NTU Singapore. It is intended to promote transparency, alignment, and a productive working relationship from the outset.

## Purpose of this Document
This document is provided before or at the beginning of the research visit to clarify expectations early and to support an effective and productive stay in the group. Its purpose is to reduce ambiguity, support mutual understanding, and help prevent avoidable misunderstandings during a relatively short and focused research period.

This document is **not an employment contract and does not replace university, school, scholarship, funding-agency, immigration, human resources, safety, ethics, or other institutional rules applicable to the visit. Official NTU policies, the rules of the home institution, and the formal terms of the visiting arrangement remain controlling where applicable. Instead, this document sets out the **research-group-level expectations that the visiting PhD student is expected to understand and accept before or at the start of joining the group.

## Nature of the Appointment
A visiting PhD appointment in the group is a research-focused, time-bounded academic engagement. In most cases, the visiting student is expected to be in a relatively advanced stage of the PhD, typically around the third or fourth year, and therefore already possesses a meaningful level of technical and scientific maturity. For this reason, the visiting appointment is not expected to function in the same way as the early years of a full PhD. The emphasis is less on broad initial training and more on focused contribution, integration into ongoing work, and the development of specific outputs within a limited period.
...
The visiting PhD student is expected to take meaningful ownership of the assigned research agenda early in the visit. Because the visit is short, it is generally not realistic to spend an extended period only becoming familiar with the work before contributing. The student is expected to understand the scientific goals, technical scope, and intended outputs of the visit relatively quickly and to begin contributing in a focused and proactive manner.
...
### Quality of work
The group places strong emphasis on rigor and quality. The visiting PhD student is expected to produce work that is scientifically sound, technically careful, reproducible where relevant, and presented to a professional academic standard.
...
### Stage-specific expectations across the visit
The visiting appointment is short and therefore should be treated as a focused research period rather than a broad exploratory phase. While every visit is different, the expected trajectory generally follows three broad stages.
...
The visiting PhD student is expected to maintain regular communication with the supervisor and relevant team members.
...
A visiting PhD appointment is an outcomes-driven research engagement rather than a purely time-clocked role. At the same time, the visiting PhD student is expected to demonstrate a professional level of presence, engagement, and reliability.
...
Good documentation is especially important in a visiting arrangement because the visit ends while the broader project usually continues. Documentation is therefore essential for continuity, reuse, authorship clarity, and later dissemination of the work.

## Publications, Authorship, and Academic Credit
### Publication culture
The group values high-quality scholarly publication and responsible dissemination. The visiting PhD student is expected to contribute actively to manuscript preparation, revision, and submission when publication is an appropriate output of the work.

Because many visits are too short for a full publication cycle to be completed on site, the expectation is not necessarily that a paper will be fully published during the visit itself, but rather that the work carried out should be documented and structured in a way that supports a credible path toward publication where appropriate.
...
All outputs arising from the visit are expected to include the correct institutional affiliation(s), required funding acknowledgements, and other sponsor- or project-specific statements where applicable. Where appropriate, outputs may need to reflect both the home institution and the host institution, depending on the nature of the contribution and the relevant policies.

## Data, Code, Intellectual Property, and Confidentiality
### Data and code management
Research data, code, models, annotations, figures, notes, and related materials produced as part of the visit must be handled responsibly and organized professionally. The visiting PhD student is expected to follow agreed project conventions for storage, naming, backup, version control, and documentation.

### Ownership and access
Materials generated within the scope of the visit, especially where tied to funded projects, collaborations, group infrastructure, or institutional resources, should be treated as project or institutional research assets rather than purely personal assets. The visiting PhD student must not withhold essential files, repositories, documentation, or access credentials needed for continuity of the research.

This point is especially important in a visiting appointment because the student will leave the group after a limited period. Departure should not create a situation in which relevant research materials remain inaccessible, undocumented, or dependent on personal accounts controlled externally.

### Confidentiality
The visiting PhD student may have access to unpublished results, confidential data, sponsor-sensitive information, reviewer discussions, internal proposals, software, or collaboration materials. Such information must not be disclosed, shared externally, or reused inappropriately without authorization.

This applies equally to communications with the home institution or external collaborators unless sharing has been agreed and is appropriate under the relevant project arrangements.

### Intellectual property and external use
Any potentially patentable, commercially sensitive, or otherwise protected outputs should be discussed before public disclosure. The visiting PhD student should not independently commercialize, license, distribute, or externally reuse project materials in ways that conflict with university policy, sponsor terms, collaboration agreements, or the legitimate interests of the group.

Where questions arise about the use of materials after the visit, those questions should be discussed explicitly rather than assumed.

## Collaboration and Team Conduct
The group values a constructive, respectful, and collaborative culture. The visiting PhD student is expected to contribute positively to that environment.
...
## Mentoring and Support of Junior Researchers
Depending on project needs and the visiting student's expertise, the student may be asked to support the technical mentoring of master students, undergraduate students, visiting students, interns, or research assistants. This may include onboarding, providing technical guidance, reviewing code or manuscripts, helping design experiments, or advising on good research practice.

Such mentoring can be a valuable part of the visit where relevant and appropriate to the student's background. However, the primary purpose of the visit remains the focused advancement of the agreed research agenda. Any mentoring role should therefore be proportionate and should not unduly reduce the visiting student's ability to deliver the main objectives of the visit.

## Funding, Resources, Travel, and Expenses
Access to equipment, software, computing resources, travel, consumables, or project-related expenses is subject to budget availability, institutional rules, project scope, and supervisory approval.
...
The visiting PhD student is expected to comply with all applicable requirements related to research integrity, human subjects, data governance, safety training, laboratory or workshop rules, fieldwork procedures, and any project-specific ethical or regulatory approvals.

No research activity requiring prior approval should begin before the relevant approvals are in place.

The fact that the student is visiting from another institution does not reduce the obligation to comply fully with host-institution requirements where applicable.

## Communication of Concerns and Resolution of Issues
A productive research environment requires open, respectful, and timely communication in both directions. The visiting PhD student is encouraged to raise concerns early whenever a problem, misunderstanding, or source of friction arises that may affect the research, working relationships, or the overall working environment.
...
## Performance Concerns and Escalation
If concerns arise regarding performance, conduct, communication, professionalism, fulfilment of responsibilities, or credible progress during the visit, the usual approach will be to discuss them directly and in good faith at an early stage. Depending on the issue, expectations may be clarified verbally or in writing, and reasonable time may be given for improvement where appropriate.
